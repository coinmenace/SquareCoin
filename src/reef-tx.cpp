...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Reef Core reef-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  reef-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded proton transaction") + "\n" +
              "  reef-tx [options] -create [commands]   " + _("Create hex-encoded proton transaction") + "\n" +
              "\n";
